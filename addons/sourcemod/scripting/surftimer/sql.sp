...
public void db_viewPlayerOptionsCallback(Handle owner, Handle hndl, const char[] error, any client)
{
	...
	if (SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		// "SELECT timer, hide, sounds, chat, viewmodel, autobhop, checkpoints, gradient, speedmode, centrehud, module1c, module2c, module3c, module4c, module5c, module6c, sidehud, module1s, module2s, module3s, module4s, module5s, speedmessagemode, speedmessage FROM ck_playeroptions2 where steamid = '%s';"
		...
		g_SpeedModeMessage[client] = SQL_FetchInt(hndl, 24);
		g_bMessageSpeedDisplay[client] = view_as<bool>(SQL_FetchInt(hndl, 25));
	...
	else
	{
		...
		g_bMessageSpeedDisplay[client] = false;
	}
